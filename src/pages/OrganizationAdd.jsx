...
function OrganizationAdd() {
    ...
    const axiosInstance = useAxios();  // Axiosni bir marta chaqirib ishlatish uchun
    ...
    function handleSubmit(e) {
        ...
        if (id) {
            axiosInstance.put(`/organization/${id}`, data)
                .then(res => {
                    console.log(res);  // So'rov natijasi kelyaptimi, tekshiring
                    setTimeout(() => {
                ...
                .catch(err => {
                    console.error(err);  // Xato bo'lsa, konsolda xato chiqsin
                    setIsLoading(false);  // Xatolik holatida loadingni to'xtatish
                });
        } else {
            axiosInstance.post(`/organization`, data)
                .then(res => {
                    console.log(res);  // So'rov natijasi kelyaptimi, tekshiring
                    setTimeout(() => {
    ...
    useEffect(() => {
        if (id) {
            axiosInstance.get(`/organization/${id}`)
                .then(res => {
                ...
                .catch(err => {
                    console.error(err);  // Xato bo'lsa konsolda chiqsin
                });
        }
    }, [id]);  // 'id' o'zgarsa, qayta ishlatadi
