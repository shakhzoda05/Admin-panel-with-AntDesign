            ...
            <div className="w-[70%] mt-10 flex justify-between">
                <div className="w-[49%] space-y-5">
                    ...
                    <label className="flex flex-col space-y-1">
                        ...
                        <CustomSelect options={statusDate} placeholder="Holat turini tanlang" seChooseID={setStatusId} />
                    </label>

                    <label className="flex flex-col space-y-1">
                        <span className="text-[16px] text-slate-600">Hudud nomini tanlang:</span>
                        <CustomSelect options={regionData} placeholder="Hudud nomini tanlang" seChooseID={setRegionId} />
                    </label>
                </div>

                <div className="w-[49%] space-y-5">
                    <label className="flex flex-col space-y-1">
                        <span className="text-[16px] text-slate-600">Manzil kiriting:</span>
                    ...
                    <label className="flex flex-col space-y-1">
                        <span className="text-[16px] text-slate-600">Sana kiriting:</span>
